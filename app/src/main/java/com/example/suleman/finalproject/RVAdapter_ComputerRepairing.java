...
public class RVAdapter_ComputerRepairing extends RecyclerView.Adapter<RVAdapter_ComputerRepairing.PersonViewHolder>  {
    ...
    RVAdapter_ComputerRepairing(List<Card_Content> contents){
