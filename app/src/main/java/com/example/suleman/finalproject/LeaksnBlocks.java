...
public class LeaksnBlocks extends AppCompatActivity {
    TextView disp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaksn_blocks);
    ...
    public void result(View v) {
        if (v.getId() == R.id.add) {
            if (countBasin == 0) {
                ...
                cloggedBasin.setText(countBasin + " Clogged Basin");
                ...
                total += 50;
                disp.setText("Total : Rs " + total);
                cloggedBasin.setText(countBasin + " Clogged Basin & above");
            }
        }
            ...
            if (countToilet == 0) {
                ...
                total += 250;
                disp.setText("Total : Rs " + total);
                cloggedToilet.setText(countToilet + " Clogged Toilet");
                ...
                total += 50;
                disp.setText("Total : Rs " + total);
                cloggedToilet.setText(countToilet + " Clogged Toilet & above");
            }
        }
            ...
            if (countDrain == 0) {
                ...
                total += 250;
                disp.setText("Total : Rs " + total);
                cloggedDrain.setText(countDrain + " Clogged Drain");
                ...
                total += 50;
                disp.setText("Total : Rs " + total);
                cloggedDrain.setText(countDrain + " Clogged Drain & above");
            }
        }
            ...
            if (countFix == 0) {
                ...
                total += 250;
                disp.setText("Total : Rs " + total);
                blockageFix.setText(countFix + " Water Blockage Fixing");
            } else if (countFix == 1) {
                countFix++;
                total += 100;
                disp.setText("Total : Rs " + total);
                ...
                total += 50;
                disp.setText("Total : Rs " + total);
                blockageFix.setText(countFix + " Water Blockage Fixing & above" );
            }
        }
            ...
            if (countRepair == 0) {
                ...
                total += 250;
                disp.setText("Total : Rs " + total);
                leakageRepair.setText(countRepair + " Leakage Repair");
                ...
                total += 50;
                disp.setText("Total : Rs " + total);
                leakageRepair.setText(countRepair + " Leakage Repair & above");
            }
        }
