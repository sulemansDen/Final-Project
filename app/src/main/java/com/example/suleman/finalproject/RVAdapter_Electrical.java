...
public class RVAdapter_Electrical extends RecyclerView.Adapter<RVAdapter_Electrical.PersonViewHolder>  {
    ...
    public static class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            if(position==2)
            {
                Intent i = new Intent(context,PlugnSwitch.class);
                context.startActivity(i);
            }
            if(position==3)
            {
                Intent i = new Intent(context,TvnEntertainment.class);
                context.startActivity(i);
            }
        }
    }
    ...
    RVAdapter_Electrical(List<Card_Content> contents){
