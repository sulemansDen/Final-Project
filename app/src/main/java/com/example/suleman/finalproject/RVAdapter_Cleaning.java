...
public class RVAdapter_Cleaning extends RecyclerView.Adapter<RVAdapter_Cleaning.PersonViewHolder>  {
    ...
    public static class PersonViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            {
                Intent i = new Intent(context,SofaCleaning.class);
                context.startActivity(i);
            }
            else if(position==3)
            {
                Intent i = new Intent(context,BathroomCleaning.class);
                context.startActivity(i);
            }
            else if(position==4)
            {
    ...
    RVAdapter_Cleaning(List<Card_Content> contents){
